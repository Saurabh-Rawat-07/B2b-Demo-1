...
// <!-- Initialize Swiper categories  -->
var swiper = new Swiper(".mySwiper-cate", {
    slidesPerView: 4,
    spaceBetween: 10,
    pagination: {
        el: ".swiper-pagination",
...
// <!-- Initialize Swiper tranding categouries-->
var swiper = new Swiper(".mySwiper-res-tranding-cate", {
    slidesPerView: 2,
    spaceBetween: 10,
    pagination: {
        el: ".swiper-pagination",
...
// <!-- Initialize Swiper realestate -->
var swiper = new Swiper(".mySwiperrealestate", {
    slidesPerView: 2,
    loop: true,
    autoplay: {
        delay: 2000,
